...
export interface UserNaturalResponse {
     ...
     */
    nationality?: UserNaturalResponse.NationalityEnum;

    /**
     * The user’s country of residence. ISO 3166-1 alpha-2 format is expected
     */
    countryOfResidence?: UserNaturalResponse.CountryOfResidenceEnum;
     ...
     * Type of user
     */
    personType?: UserNaturalResponse.PersonTypeEnum;

    /**
     * 
     */
    kYCLevel?: UserNaturalResponse.KYCLevelEnum;
...
export namespace UserNaturalResponse {
